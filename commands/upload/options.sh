...
#
#/ usage: discount-rpm:upload [ --release <1>] [ --version <2.1.3>] [ --owner <dtolabs>] [ --repository <discount-rpm>] [ --package-name <discount>] [ --architecture <$(uname -p)>] [ --distribution-release-version <$(rerun rpm:get-distribution-release-version)>] 
...
rerun_options_parse() {
    ...
    [ -z "$REPOSITORY" ] && REPOSITORY="discount-rpm"
